...
mvn --batch-mode \
  -P distribution \
  -Dresume=false \
  -Dtag=deca-parent_2.10-${release} \
  -DreleaseVersion=${release} \
  -DdevelopmentVersion=${devel} \
  -DbranchName=deca_2.10-${release} \
  release:clean \
  release:prepare \
  release:perform
...
cp deca-cli/target/deca-cli_2.10-${release}.jar deca-${release}.jar
cp deca-cli/pom.xml deca-${release}.pom
zip -r deca-${release}.zip deca-${release}.jar deca-${release}.pom
...
mvn --batch-mode \
  -P distribution \
  -Dresume=false \
  -Dtag=deca-parent_2.11-${release} \
  -DreleaseVersion=${release} \
  -DdevelopmentVersion=${devel} \
  -DbranchName=deca_2.11-${release} \
  release:clean \
  release:prepare \
  release:perform
...
mvn --batch-mode \
  -P distribution \
  -Dresume=false \
  -Dtag=deca-parent-spark2_2.10-${release} \
  -DreleaseVersion=${release} \
  -DdevelopmentVersion=${devel} \
  -DbranchName=deca-spark2_2.10-${release} \
  release:clean \
  release:prepare \
  release:perform
...
mvn --batch-mode \
  -P distribution \
  -Dresume=false \
  -Dtag=deca-parent-spark2_2.11-${release} \
  -DreleaseVersion=${release} \
  -DdevelopmentVersion=${devel} \
  -DbranchName=deca-spark2_2.11-${release} \
  release:clean \
  release:prepare \
  release:perform
