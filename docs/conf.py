# -*- coding: utf-8 -*-
# bdgenomics.deca documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'deca.tex', u'bdgenomics.deca Documentation',
...
man_pages = [
    (master_doc, 'bdgenomics.deca', u'bdgenomics.deca Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Deca', u'bdgenomics.deca Documentation',
   author, 'Deca', 'DECA: scalable copy number variant calling',
   'Miscellaneous'),
]
